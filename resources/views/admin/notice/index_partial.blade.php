            ...
            <tr>
                ...
                <td>
                    <div class="btn-group btn-group-sm">
                        <a class="btn btn-primary text-white" href="{{route('admin.notice.edit', $notice->id)}}"> @lang('admin/app.modify') </a>
                        <button class="btn btn-danger btn-delete text-white" href="{{route('admin.notice.delete', $notice->id)}}"> @lang('admin/app.delete') </button>
                    </div>
                </td>
            </tr>
            @endforeach
