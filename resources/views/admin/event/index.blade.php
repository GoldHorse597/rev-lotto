...
@section('main-content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">@lang('admin/app.events')</h1>
    </div>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="d-flex justify-content-end">
                <button class="btn btn-success" data-toggle="modal" data-target="#eventCreateModal">
                    <i class="fas fa-plus fa-sm text-white-50"></i> @lang('admin/app.new_event') </button>
            </div>
        </div>
        <div class="card-body">
            {!! $partial_view !!}
    ...
    <div class="modal fade" id="eventCreateModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('admin/app.new_event')</h5>
                ...
                <form method="post" action="{{route('admin.event.create')}}">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="eventTitle" class="col-sm-4 col-form-label">@lang('admin/app.event') @lang('admin/app.subject')</label>
                            <div class="col-sm-8">
                                <div class="input-group ">
                                    <input type="text" class="form-control" id="eventTitle" name="title" value=""
                                        data-rule-required="true" data-msg-required="{{ sprintf(trans('admin/app.required'), trans('admin/app.subject')) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="eventContent" class="col-sm-4 col-form-label">@lang('admin/app.event') @lang('admin/app.content')</label>
                            <div class="col-sm-8">
                                <div class="input-group ">
                        ...
                        <div class="form-group row">
                            <label for="eventStatus" class="col-sm-4 col-form-label">@lang('admin/app.status')</label>
                            <div class="col-sm-8">
                                <div class="input-group">
