...
@section('main-content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"> #{{$bank->name}} @lang('admin/app.modify')</h1>
    </div>

    <div class="card shadow mb-4">
        <div class="card-header">
            <h6 class="m-0 font-weight-bold text-primary"> #{{$bank->name}} @lang('admin/app.modify')</h6>
        </div>
        <div class="card-body">
            
            <div class="tab-content">
                <div class="tab-pane active" id="main_info">
                    <form id="userEditForm" action="{{route('admin.bank.edit', $bank->id)}}" method="post">
                        @method('PUT')
                        @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td class="form-group">
                                            <div class="input-group" style="max-width: 400px;">
                                                <input type="text" class="form-control" id="bank" name="bank" value="{{$bank->name}}"
